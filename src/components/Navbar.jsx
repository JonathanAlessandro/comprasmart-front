  ...
  return (
    <header className="w-full px-6 md:px-12 py-4 flex justify-between items-center fixed top-0 z-50 transition-all duration-300 bg-white/80 backdrop-blur-md border-b border-gray-100 shadow-sm">
      ...
      <nav className="hidden md:flex gap-8 text-gray-600 font-medium text-sm lg:text-base">
        <a href="#solucao" className="hover:text-emerald-600 hover:scale-105 transition-all">
          Funcionalidades
        </a>
        <a href="#pricing" className="hover:text-emerald-600 hover:scale-105 transition-all">
          Planos
        </a>
        <a href="#faq" className="hover:text-emerald-600 hover:scale-105 transition-all">
        ...
        <div className="md:hidden">
          <Sheet>
            <SheetTrigger asChild>
              <Button variant="ghost" size="icon" className="hover:bg-emerald-50 text-emerald-600">
            ...
            <SheetContent side="right" className="bg-white/95 backdrop-blur-sm border-l-0">
              ...
              <nav className="flex flex-col gap-6 text-lg font-medium text-gray-700">
                <a href="#solucao" className="hover:text-emerald-600 border-b border-gray-100 pb-2">
                  Funcionalidades
                </a>
                <a href="#pricing" className="hover:text-emerald-600 border-b border-gray-100 pb-2">
                  Planos
                </a>
                <a href="#faq" className="hover:text-emerald-600 border-b border-gray-100 pb-2">
                  Perguntas Frequentes
                </a>
                <div className="mt-8">
                  <Link to="/login" className="w-full">
                    <Button className="w-full bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl py-6 text-lg font-bold shadow-md">
                      Entrar na Conta
                    </Button>
                  </Link>
                </div>
